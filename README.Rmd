...
on_travis = Sys.getenv("USER") == "travis"
# on_travis = TRUE
...
```{r plot1-backup,out.width='50%',echo=FALSE,eval=on_travis}
knitr::include_graphics("https://raw.githubusercontent.com/r-spatial/stars/master/images/plot1-1.png")
```
...
```{r plot2,echo=FALSE,eval=!on_travis}
x = 1:5
y = 1:4
...
```{r plot2-backup,out.width='50%',echo=FALSE,eval=on_travis}
knitr::include_graphics("https://raw.githubusercontent.com/r-spatial/stars/master/images/plot2-1.png")
```
...
```
```{r plot3-backup,out.width='50%',echo=FALSE,eval=on_travis}
knitr::include_graphics("https://raw.githubusercontent.com/r-spatial/stars/master/images/plot3-1.png")
```
...
```{r plot4,eval=!on_travis}
a = aggregate(prec, by = nc, FUN = max)
plot(a, max.plot = 23, border = 'grey', lwd = .5)
```
```{r plot4-backup,out.width='50%',echo=FALSE,eval=on_travis}
knitr::include_graphics("https://raw.githubusercontent.com/r-spatial/stars/master/images/plot4-1.png")
```
...
```{r plot5, fig.height=3,eval=!on_travis}
...
```
```{r plot5-backup,out.width='50%',echo=FALSE,eval=on_travis}
knitr::include_graphics("https://raw.githubusercontent.com/r-spatial/stars/master/images/plot5-1.png")
```
