...
tribble(
  ...
  "names", "names", "",
  "xres", "st_res(x)[1], look for delta", "may not be a constant in case of rectilinear or curvilinear grids", 
  "yres", "st_res(x)[2], look for delta", "may not be a constant in case of rectilinear or curvilinear grids", 
  "xmin", "st_bbox(x)[1]", "",
  "xmax", "st_bbox(x)[3]", "",
  "ymin", "st_bbox(x)[2]", "",
  "ymax", "st_bbox(x)[4]", "",
